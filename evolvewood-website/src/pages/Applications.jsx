...
const appImg1 = "/images/storageandcivil.png?v=3";
...
const Applications = () => {
  return (
    <>
      <SEO
        title="Applications"
        description="Application in various sectors including industrial, storage, civil, and agriculture."
      />
      <div className="bg-[#f5f5ee] min-h-screen py-16 px-6 md:px-16 pt-32">
        ...
        >
          <div className="order-2 md:order-1">
            ...
            <p className="text-gray-600 leading-relaxed">
              Our high-strength profiles are engineering marvels designed for
              heavy industry. They replace traditional materials in chemical
              factories, steel plants, and heavy machinery packaging. Resistant
              to corrosion, chemicals, and shock, they are perfect for export
              packaging and structural support.
            </p>
          ...
          <motion.img
            ...
            onError={(e) => {
              e.target.src =
                "https://placehold.co/600x400?text=Please+Upload+application_industrial.jpg";
            }}
          />
        </motion.div>
        ...
        >
          <motion.img
            ...
            onError={(e) => {
              e.target.src =
                "https://placehold.co/600x400?text=Please+Upload+storageandcivil.png";
            }}
          />
        ...
        >
          <div className="order-2 md:order-1">
            ...
            <p className="text-gray-600 leading-relaxed">
              In furniture and interior development, our products are used for
              modular furniture frames, decorative panels, partition systems,
              shelving structures, and custom design elements. They provide
              strong structural support, long-lasting durability, and aesthetic
              appeal while blending naturally with modern and traditional
              interior environments.
            </p>

            <ul className="mt-5 space-y-2 text-gray-700">
              <li>✔ Modular Furniture Frames</li>
              <li>✔ Tables & Seating Structures</li>
              <li>✔ Shelving & Storage Units</li>
              <li>✔ Decorative & Partition Panels</li>
            </ul>
          </div>
          ...
          <motion.img
            ...
            onError={(e) => {
              e.target.src =
                "https://placehold.co/600x400?text=Please+Upload+application2.jpg";
            }}
          />
        </motion.div>
      </div>
